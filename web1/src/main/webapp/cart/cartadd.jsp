...
<%
	...
	ArrayList<String> products = (ArrayList<String>)session.getAttribute("products"); // 확인을 위해 getAttribute 사용
	...
	// 가져온 자동차 정보를 session 에 저장 => 장바구니
	//session.setAttribute("product", product); - 하나일때
