...
//		products[0] = new Product();	//Cannot instantiate the type Product
		products[0] = new CellPhone("아이폰14", 1500000, "SKT");
		products[1] = new CellPhone("갤럭시S23", 1500000, "KT");
		products[2] = new SmartTv("samsumg smartTv", 3500000, "8K");
		products[3] = new SmartTv("LG OLED Tv", 2500000, "4k");
	}
