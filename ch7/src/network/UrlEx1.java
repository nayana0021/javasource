 ...
 *  파일명 : String.html 
 *  쿼리 : URL 에서 ? 이후의 부분 where=nexearch&sm=top_hty&fbm=1&ie=utf8&query=영화 (키,밸류 형태로 붙는다)
 *  
 * 
 */
public class UrlEx1 {
	public static void main(String[] args) {
		...
		System.out.println("url.getgetContent() : "+url.getContent());
		...
		System.out.println("url.getFQuery() : "+url.getQuery());
