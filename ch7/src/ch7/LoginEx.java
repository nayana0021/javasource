...
/* 
 * Exception 클래스를 상속받아서 NotExistIdException, WrongPasswordException 작성 - 사용자 정의 예외
 * 
 */
public class LoginEx {
	...
	public static void login(String id, String pwd) throws NotExistIdException, WrongPasswordException {
		//id가 blue와 일치하지 않는다면 NotExistIdException 발생 - 강제로
		if(!id.equals("blue")) {
			throw new NotExistIdException("아이디를 확인해주세요.");
		} 
		//pwd가 12345와 일치하지 않는다면 WrongPasswordException 발생 - 강제로
		if(!pwd.equals("12345")) {
