...
public class MemberChangeAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request) throws Exception {
		...
		// userid 와 현재 비밀번호를 가지고 일치하는 회원이 있는지 확인(해당 서비스 호출)
		MemberLoginService loginSerivce = new MemberLoginService();
		MemberDTO info = loginSerivce.login(dto.getUserid(), dto.getCurrentPassword());
